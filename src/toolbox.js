...
<xml xmlns="https://developers.google.com/blockly/xml" id="toolbox" style="display: none">
    <category name="Community" css-icon="customIcon2 fa fa-user">
        <label text="Check out community made blocks by JT Users."/>
        <label text="Press the &quot;Push&quot; button to increase it's chance of being a future block."/>
        <sep gap="64"/>
    ...
    <category name="Favorites" css-icon="customIcon2 fa fa-star">
    ...
    <category name="Files" colour="#faaf00">
        ...
        <category name="Images" colour="#fa8100">
            <category name="Image Editing" colour="#e67600">
                <label text="This category is currently undergoing updates."/>
                <label text="Expect weird behavior or visual changes."/>
                <sep gap="64"/>
